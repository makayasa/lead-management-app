              ...
              children: [
                ...
                Padding(
                  ...
                  child: FormBuilderDropdown(
                    key: controller.formz,
                    name: 'type',
                    initialValue: controller.data.value.status,
                    onChanged: (value) {
                    ...
                    items: [
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.LISTING,
                        child: Row(
                          children: [
                      ...
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.INSPECTING,
                        child: Row(
                          children: [
                      ...
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.VISITED,
                        child: DefText('Visited').normal,
                      ),
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.ASSIGNING_SURVEYOR,
                        child: DefText('Assigning Surveyor').normal,
                      ),
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.SURVEYING,
                        child: DefText('Surveying').normal,
                      ),
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.APPROVAL,
                        child: DefText('Approval').normal,
                      ),
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.PURCHASING_ORDER,
                        child: DefText('Purchasing Order').normal,
                      ),
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.REJECTED,
                        child: DefText('Rejected').normal,
                      ),
                      DropdownMenuItem(
                        value: FinancingStatusHelpers.UNIT_NOT_AVAILABLE,
